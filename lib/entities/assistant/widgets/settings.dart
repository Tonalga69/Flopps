...
class _AssistantSettingsState extends State<AssistantSettings> {
  ...
  setPermission() {
    _assistantController
        ...
        .then((value) => overlayPermission = value);
    _assistantController
        .getNotificationPermission()
        .then((value) => notificationPermission = value);
    _assistantController
        .getMicroPhonePermission()
        .then((value) => microphonePermission = value);
  }
                ...
                Row(
                  ...
                  children: [
                    ...
                    OutlinedButton(
                        ...
                        style: enableButtonStyle,
                        child: Text(
                          overlayPermission ? Strings.enable : Strings.unable,
                          style: enableTextStyle,
                        )),
                    const Padding(padding: EdgeInsets.all(1)),
                  ],
